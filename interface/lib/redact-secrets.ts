...
// the DB, or an HTTP response. RPC errors from viem regularly include the full provider URL
// (e.g. https://eth-mainnet.g.alchemy.com/v2/<KEY>) which would otherwise leak the key into
// Slack/Telegram alerts and the executions row's error column.
